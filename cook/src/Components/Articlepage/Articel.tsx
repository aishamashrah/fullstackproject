    ...
    return (
        ...
        <CookEaseHeader />
            ...
            <div className="w-1/2 mx-auto block relative font-lobster md:text-5xl w-7/12  text-center pt-9 ">
                <h1  >Grant Achatz: The Innovative Chef Redefining Fine Dining</h1>
            </div>
            <img src={chefHat2} alt="Dashboard icon" className="mx-auto block mt-4 h-10 sm:h-20 lg:h-40" />
            <p className='text-center font-serif'>By Chat GPT</p>
            ...
            <p className=' mx-auto xl:ml-32 px-6 '>March 29, 2023 Chef Profile</p>
