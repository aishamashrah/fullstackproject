        ...
        <div className=" gap-4 header p-5  mb-30  ">
            <div className=" flex sm:text-xs  items-center relative">
                ...
                <label className=" mx-auto sm:col-span-4 sm:grid-cols-12 ">
                    ...
                    <input className=" block bg-white mt-4 w-full sm:w-72 md:W-96 sm:w-96   rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline"
            ...
            <div className="flex justify-center ">
                    <div className="text-left">
                        <button type="button" className="inline-flex w-full justify-center sm:gap-x-1 rounded-md py-2 text-sm font-semibold text-gray-900  hover:bg-gray-50" id="menu-button" aria-expanded="true" aria-haspopup="true">
                            Search
