...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      <div className="container h-screen mx-auto md:border-spacing-y-96 bg-slate-50 mt-16 rounded-md border  border-black ">
          ...
          <div className="w-full  col-span-2 ">
            ...
            <div className="flex flex-col lg:text-base md:text-xs  md:flex-row gap-6 ">
              <div className=" p-4 rounded-md bg1">
                ...
                <h6 className='text-sm font-serif text-right pt-8'>See all</h6>
              </div>
              <div className=" p-4 rounded-md bg1  ">
                ...
                <p className='p-4 font-serif'>Pasta Primaveria with Grilled Shrimp and Truffle OilPasta Primaveria with Grilled Shrimp and Truffle OilPasta Primaveria with Grilled Shrimp and Truffle Oil</p>
                <h6 className='text-sm font-serif text-right pt-8 hover'>See all</h6>
              </div>
              <br></br>
              <br></br>
              <br></br>
            </div>
            <div className=" rounded-md LastBg md:mt-20   md:h-64">
              <div className="flex flex-col md:flex-row justify-between  lg:text-base  md:text-xs p-6">
                <div className="">
                  <h3 className="font-serif font-bold">Name</h3>
                  <img src={chefHat2} alt="Dashboard icon" className="w-full h-auto md:h-28" />
                </div>
                <div className="flex justify-center">
                  <svg className="w-2 h-full  hidden hidden md:block sm:block">
                ...
                <div className="flex justify-center">
                  <svg className="w-2 h-full hidden sm:block">
                    <line x1="0" y1="0" x2="0" y2="100%" stroke="currentColor" stroke-width="2" />
                  </svg>
                </div>
                <div className="w-full md:w-1/3 ">
